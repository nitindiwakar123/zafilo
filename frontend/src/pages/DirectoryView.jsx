...
import { CreateDirectoryModal, DirectoryHeader, DirectoryList, RenameModal } from "../components";
...
function DirectoryView() {
  ...
  async function handleDeleteDirectory(id) {
    await fetch(`${BASE_URL}/folder/${id}`, {
      method: "DELETE",
      credentials: "include",
    });
    getDirectoryItems();
  ...
  async function handleCreateDirectory(e) {
    e.preventDefault();
    await fetch(`${BASE_URL}/folder/${dirId || ""}`, {
      method: "POST",
      headers: {
        dirname: newDirname,
      },
  ...
  async function handleRenameSubmit(e) {
    ...
    if (renameType === "file") {
      ...
      await fetch(`${BASE_URL}/folder/${renameId}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
